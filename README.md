...
<div style="display: flex; background: rgba()">
  <br>
  <img style="margin: auto; height="200" widht="200" alt="html5" src="https://res.cloudinary.com/dnwd2por2/image/upload/v1716647003/van-sunset.jpg" />
</div>

### Sou graduando em `Engenharia de Software` pela  e `Técnico em Desenvolvimento de Sistemas`. Apaixonado por desenvolvimento `Front-End`, pois este foi um dos meus primeiros contatos com desenvolvimento. Contudo, pretendo colocar bastante coisa de variados temas aqui no meu perfil.
